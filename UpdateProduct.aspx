<%@ Page Title="" Language="C#" MasterPageFile="~/Kota.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="ASPNET_FrontEnd.UpdateProduct" %>
                ...
                <div class="row fill_height">
                    <div class="col-lg-4 offset-lg-4 fill_height">
                        <div class="banner_content">
                            <form action="UpdateProduct.aspx" method="post" class="contact-form" runat="server">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <asp:Button ID="btnUpdate" type="submit" runat="server" Text="Add New Product" class="btn btn-warning py-2 px-5" OnClick="btnUpdate_Click" />
                                </div>
