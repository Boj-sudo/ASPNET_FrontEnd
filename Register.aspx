<%@ Page Title="" Language="C#" MasterPageFile="~/Kota.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ASPNET_FrontEnd.Register" %>
                ...
                <div class="row fill_height">
                    <div class="col-lg-4 offset-lg-4 fill_height">
                        <div class="banner_content">
                            <form action="Register.aspx" method="post" class="contact-form" runat="server">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <asp:Button ID="btnRegister" type="submit" runat="server" Text="Register" class="btn btn-warning py-2 px-5" OnClick="btnRegister_Click" />
                                </div>
